...
export async function HomePageTemplate() {
  ...
  const testimonials = locale === "ru" ? require("@/content/testimonials/ru").testimonials : require("@/content/testimonials/en").testimonials
  ...
  return (
    <>
      ...
      <section id="reviews" className="container relative z-30 space-y-12 bg-background py-10">
      ...
      <section className="container relative z-30 space-y-12 overflow-clip rounded-b-[56px] bg-background py-10">
        <div className="flex flex-col items-end gap-12 py-6 lg:flex-row">
          ...
          <h5 className="max-w-lg font-medium text-muted-foreground">{t("description2")}</h5>
